...
print("75th percentile error:",end=' ')
print(np.percentile(np.array(err3),75))
print("95th percentile error:",end=' ')
print(np.percentile(np.array(err3),95))
...
print("Anchors with maximum error:")

a1=np.argmax(me2)
print(anchors[a1])
x1=np.array([anchors[a1][0][0],anchors[a1][1][0],anchors[a1][2][0]])
y1=np.array([anchors[a1][0][1],anchors[a1][1][1],anchors[a1][2][1]])
plt.scatter(x1,y1)
a1=np.argmax(me3)
print(anchors[a1])
x2=np.array([anchors[a1][0][0],anchors[a1][1][0],anchors[a1][2][0]])
y2=np.array([anchors[a1][0][1],anchors[a1][1][1],anchors[a1][2][1]])
plt.scatter(x2,y2)
a1=np.argmax(me4)
print(anchors[a1])
x3=np.array([anchors[a1][0][0],anchors[a1][1][0],anchors[a1][2][0]])
y3=np.array([anchors[a1][0][1],anchors[a1][1][1],anchors[a1][2][1]])
plt.scatter(x3,y3)
plt.show()